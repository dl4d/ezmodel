...
transformers = data.transform(X="minmax",y="minmax")
...
generator = UNET(input=data,transformers=transformers,parameters=parameters)
...
discriminator.compile(
                      ...
                      keras.optimizers.RMSprop(lr=0.05),
...
batch_size = 32
epochs = 1000
logdir = "C:\\Users\\daian\\Desktop\\LOGDIR\\GAN-SEG\\"
